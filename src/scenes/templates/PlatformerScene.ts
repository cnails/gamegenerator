...
export class PlatformerScene extends VerticalBaseScene {
  ...
  /**
   * Базовые настройки движения игрока.
   * В initGame они дополнительно «дрожатся» случайным образом,
   * чтобы даже при одинаковом профиле игры чувствовались разные забеги.
   */
